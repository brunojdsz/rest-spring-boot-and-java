...
import br.com.brunojdsz.serialization.converter.YamlJackson2HttpMesageConverter;
...
public class WebConfig implements WebMvcConfigurer{
	...
	@Bean
	public HttpMessageConverter<?> yamlJackson2HttpMessageConverter() {
		return new YamlJackson2HttpMesageConverter();
	}
	...
	@Bean
	public CommandLineRunner migrate(org.flywaydb.core.Flyway flyway) {
		return args -> {
			flyway.migrate();
		};
	}
